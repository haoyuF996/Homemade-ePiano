...
sample_width = 2
pianlib = [[1,83],[2,61],[3,53],[4,55],[5,54],[6,47],[7,39],[8,44],[9,41],[10,27]]
...
def Note(note,duration,volume,Prefix,delay=0):
    framerate = 44100
    if note=='0':
        NoteLen = duration
...
<1* 7_ <1 <3 7-- 3_ 3_ 6* 5_ 6 <1 5-- 3 4 <1_ 7* <1 <2_ <2 <3_ <1-^ 0_ <1_ 7_ 6 7 5# 6-- <1 <2 <3* <2_ <3 <5
<2-- 5_ 5_ <1* 7 <1 <3 <3--- 6_ 7_ <1 7_ <1_ <2 <2_ <1* 5_ 5- <4 <3 <2 <1 <3--- <3-^ 0 <3 <6- <5- 
